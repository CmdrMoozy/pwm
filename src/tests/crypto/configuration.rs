...
fn write_configuration() {
    ...
    c.mut_piv_keys().push(crate::piv::util::PivKeyAssociation {
        ...
        chuid: vec![
            ...
            0x68, 0x58, 0x21, 0x08, 0x42, 0x10, 0x84, 0x21, 0x38, 0x42, 0x10, 0xc3, 0xf5, 0x34,
            0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x35, 0x08, 0x32, 0x30, 0x33, 0x30, 0x30, 0x31, 0x30, 0x31, 0x3e,
            0x00, 0xfe, 0x00,
        ],
        wrapping_key_digest: Digest::from_bytes(b"Hello, world!"),
        slot: piv::id::Key::KeyManagement,
